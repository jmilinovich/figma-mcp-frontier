...
| 2 | **Reproducible benchmark harness + live results** — read fidelity, per-tool token cost, write success-rate | 🟢 **10 of 12 experiments resolved** (only Code Connect E05/E11 seat-walled) + 4 write rungs + shadcn scorecard → [`results/`](results/) |
